...
# y = x * 3 + 0.8 * torch.rand(x.size())      # noisy y data (tensor), shape=(100, 1)
y = x ** 3 + 0.2 * torch.rand(x.size())      # noisy y data (tensor), shape=(100, 1)
...
with writer:
    writer.add_graph(net, input_to_model=torch.rand(20,1))
